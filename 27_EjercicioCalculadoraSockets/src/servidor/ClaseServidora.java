	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			try (Socket socket = ss.accept();) {
				...
				String codigoOperacion = numeros[2];

				int iNumero1 = Integer.parseInt(numero1);
				int iNumero2 = Integer.parseInt(numero2);
				int iCodigoOperacion = Integer.parseInt(codigoOperacion);
				int resultado = 0;
				
				String error = "";
				
				switch (iCodigoOperacion) {
				case 1://suma
				...
				case 4://division
					try {
						...
						resultado = 0;
						error = "no admito divisores entre 0";
					}
					break;
				default:
					break;
